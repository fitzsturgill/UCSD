function setaxesOnaxesmatrix(hAxes,nrow,ncol,ind,params,fid, outer)
...
if nargin == 7
    outer = 1;
    params(1).cellmargin = [0 0 0 0]; % force cell margin to be zero-filled
else
    outer = 0;
end
    %FS MOD
...
for i = 1:length(ind)
    ...
    if outer
        set(hAxes(i),'OuterPosition',axpos,'Parent',fid);
    else
