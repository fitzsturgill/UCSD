...
RigDef.User.ID                             = 'SRO';
% Directories
RigDef.Dir.Data                            = 'C:\SRO DATA\Data\RawData\';          % Store raw .daq data files             
RigDef.Dir.DataFilt                        = 'C:\SRO DATA\Data\RawData\Filtered\'; 
RigDef.Dir.Analyzed                        = 'C:\SRO DATA\Data\Analyzed\';
RigDef.Dir.Spikes                          = 'C:\Documents and Settings\Shawn\My Documents\Dropbox\L6 Final Analysis\Example neurons\Spikes\'; % spike sorting
RigDef.Dir.Stimuli                         = 'C:\SRO DATA\Data\Stimuli\';  % Local storage of stimuli  
RigDef.Dir.Expt                            = 'C:\Documents and Settings\Shawn\My Documents\Dropbox\L6 Final Analysis\Example neurons\Expt\';  % Important. Define experiment details.  
RigDef.Dir.FigOnline                       = 'C:\SRO DATA\Data\FiguresOnline\';  
RigDef.Dir.Settings                        = 'C:\SRO DATA\Settings\';  % Default configuration for Daq board
