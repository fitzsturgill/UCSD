...
RigDef.DAQPC_IP                            = '132.239.203.76';
...
RigDef.User.ID                             = 'FS';
% Directories
RigDef.Dir.CodeRoot                        = 'C:\Fitz\Data';
RigDef.Dir.Icons                           = [RigDef.Dir.CodeRoot, 'GuiTools\Icons\'];

RigDef.Dir.Data                            = 'C:\Fitz\Data\RawData\';                       
RigDef.Dir.DataFilt                        = 'C:\Fitz\Data\RawData\Filtered\'; 
RigDef.Dir.Analyzed                        = 'C:\Fitz\Data\RawData\Analyzed\';
RigDef.Dir.Spikes                          = 'C:\Fitz\Data\Spikes\';
% RigDef.Dir.Stimuli                         = 'C:\SRO DATA\Data\Stimuli\';    
RigDef.Dir.Expt                            = 'C:\Fitz\Data\Expt\';   
% RigDef.Dir.FigOnline                       = 'C:\SRO DATA\Data\Experiments\FiguresOnline\';  
RigDef.Dir.Settings                        = 'C:\Fitz\Settings\';  
RigDef.Dir.VStimLog                        = 'C:\Fitz\VStimLog\';
RigDef.Dir.Fig                             = 'C:\Fitz\Figures\DataFigures\';
...
RigDef.ChannelOrder                        = {[2 3 7 5 12 10 14 15 1 6 8 4 13 9 11 16 0 17]+1 ... % 2x2
                                              [16 8 15 7 12 4 13 5 10 2 9 1 11 3 14 6 0 17]+1 ... % 1x16
                                              [3 6 2 1 4 5 8 7 10 9 12 13 16 15 11 14 0 17]+1 ... % 4x1
                                              [2 1 3]}; % Glass electrode
                                                 
                                          %  [9 8 10 7 13 4 12 5 15 2 16 1
                                          %  14 3 11 6 0 17]+1 ... % 1x16
% LED defaults
